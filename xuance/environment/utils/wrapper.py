...
class XuanCeEnvWrapper:
    ...
    @property
    def observation_space_low(self) -> spaces.Space:
        """Returns the lower bound of the observation space."""
        return getattr(self.env, 'observation_space_low', None)

    @property
    def action_space_low(self):
        """Returns the action space of the environment."""
        return getattr(self.env, 'action_space_low', None)
