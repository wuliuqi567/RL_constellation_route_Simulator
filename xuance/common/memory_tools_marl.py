...
class MARL_OnPolicyBuffer(BaseBuffer):
    ...
    def __init__(self,
        ...
        self.graph_data = []  # for storing graph data, e.g., torch_geometric.data.Data
    ...
    def sample(self, indexes: Optional[np.ndarray] = None):
        ...
        return samples_dict
    def add_graph_data(self, graph_data: List):
        """
        Adds graph data to the buffer.

        Parameters:
            graph_data (List): A list of torch_geometric.data.Data object to be added. 
