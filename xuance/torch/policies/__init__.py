...
from .deterministic import GNNBasicQnetwork  # Alias for compatibility
...
from .categorical_marl import GNN_MAAC_Policy as GNN_Categorical_MAAC_Policy
...
REGISTRY_Policy = {
    ...
    "GNN_Basic_Q_network": GNNBasicQnetwork,  # Alias for compatibility
    ...
    "GNN_Categorical_MAAC_Policy": GNN_Categorical_MAAC_Policy,
...
__all__ = [
    ...
    "Categorical_ISAC", "Categorical_MASAC", "GNN_Categorical_MAAC_Policy",
    "Gaussian_ISAC", "Gaussian_MASAC", "Gaussain_MAAC", "GNNBasicQnetwork"
]
